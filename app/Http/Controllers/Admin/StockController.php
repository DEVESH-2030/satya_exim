...
class StockController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $subcategory = $this->subcategory
                        ->where('status','1')
                        ->get();
      $stock = $this->product->select('remaning_stock');
      $query = $this->product;
...
// dd($request->all());
        ...
        try {
           ...
           #product model
           $query = $this->product->where('id',$id)->first();
           ...
           if($checkProduct)
            {   
               return response()->json([
                                        ...
                                        'message' => 'Sorry, this stock already exist.'
                                      ]);                                                
            }  
            ...
            # request param
            $primaryData = [
                           'remaning_stock'  => $request->remaning_stock ?? null,
                           'total_stock'     => $request->remaning_stock ?? null, 
                         ];   
            #store primary data
