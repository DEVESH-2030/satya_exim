                ...
                <div class="col-md-7 p-0 card-right">
                    <div class="card tab2-card">
                        <div class="card-body">
                            ...
                            <form class="form-horizontal auth-form" action="{{action('Admin\ForgotPasswordController@forgotPasswordAdmin')}}" method="post">
                                @csrf
                                ...
                                <div class="form-terms">
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <a href="{{url('admin/admin-login')}}" class="btn btn-default forgot-pass">Back to login</a>
                                    </div>
                                </div>
