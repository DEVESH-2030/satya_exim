                        ...
                        <div class="col-md-7 p-0 card-right">
                            <div class="card tab2-card">
                             ...
                             @if (\Session::has('success'))
                                <div class="alert alert-success alert-dismissible" style="background: #59b359;">
                              ...
                              @if (\Session::has('error'))
                                <div class="alert alert-danger alert-dismissible" style="background: #f8a7a7;">
                                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                                  <p>
                                    {!! \Session::get('error') !!}
                                  </p>
                              ...
                              @endif
                                    ...
                                    <form class="form-horizontal auth-form" action="{{action('Admin\ForgotPasswordController@resetPasswordSubmit')}}" method="post" enctype="multipart/form-data"> 
                                        @csrf
                                        <input type="hidden" class="form-control" name="email" value="{{$admin->email}}" required="">
                                        <div class="form-group">
                                            <input required="" name="newpassword" id="newpassword" type="password" class="form-control" placeholder="New Password">
                                        </div>
                                        <div class="form-group">
