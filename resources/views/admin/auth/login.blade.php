        ...
        c1.923,0,3.84-0.728,5.303-2.192l-83.142-83.142L393.695,417.909z"/>
                ...
                <div class="col-md-7 p-0 card-right"> 
                    <div class="card tab2-card">
                        <div class="card-body">
                            @error('credential_not_match')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror

                            @error('sign_in_successfully')
                                <div class="alert alert-success">{{ $message }}</div>
                            @enderror

                            @error('this_user_not_active')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <form action="{{ route('adminLogin') }}" method="post" class="form-horizontal auth-form">
                                @csrf
                                ...
                                <div class="form-terms">
                                    <div class="custom-control custom-checkbox mr-sm-2">
                                        <!-- <input type="checkbox" name="remember_token" class="custom-control-input" id="customControlAutosizing">
                                        <label class="custom-control-label" for="customControlAutosizing">Remember me</label> -->
                                        <a href="{{action('Admin\ForgotPasswordController@index')}}" class="btn btn-default forgot-pass">lost your password</a>
                                    </div>
                                </div>
