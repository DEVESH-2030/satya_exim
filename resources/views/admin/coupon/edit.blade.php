    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title f-w-600" id="exampleModalLabel">Edit Coupon</h5>
                <button class="close cancel-model" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <form class="needs-validation" action="{{action('Admin\CouponController@edit',[$coupon->id]) }}" method="post" enctype="multipart/form-data" name="edit_model" id="edit_model">
                    @csrf
                    <div class="form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="start_date" id="datefield1" value="{{$coupon->start_date}}">
                        </div>
                        <div class="form-group">
                            <label for="validationCustom02" class="mb-1">End Date</label>
                            <input type="date" class="form-control" name="end_date" id="datefield2" value="{{$coupon->end_date}}">
                        </div>
                       {{--  <div class="form-group">
