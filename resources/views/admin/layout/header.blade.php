                ...
                <ul class="nav-menus">
                  ...
                  <!--   <li><a href="#"><i class="right_side_toggle" data-feather="message-square"></i><span class="dot"></span></a></li> -->
                    ...
                    <li class="onhover-dropdown">
                        <div class="media align-items-center"><img class="align-self-center pull-right img-50 rounded-circle blur-up lazyloaded" src="{{url($getInfo->image ?? 'admin/assets/images/dashboard/designer.jpg')}}" alt="header-user">
                            <div class="dotted-animation"><span class="animate-circle"></span><span class="main-circle"></span></div>
                        </div>
                        <ul class="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                            <li><a href="{{url('admin/profile')}}"><i data-feather="user"></i>Profile</a></li>
                            <li><a href="{{ action('Admin\AdminController@logout') }}"><i data-feather="log-out"></i>Logout</a></li>
                        </ul>
                    </li>
                </ul>
