            ...
            <div class="row partition4">
                <div class="col-lg-3 col-md-6 p-1">
                    <a href="{{url('product-details')}}">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="{{url('img/collection/Banner.jpg')}}"
                ...
                <div class="col-lg-3 col-md-6 p-1">
                    <a href="{{url('product-details')}}">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="{{url('img/collection/Banner-2.jpg')}}" class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-4">
                                <div>
                                    <h4>save 30%</h4>
                ...
                <div class="col-lg-3 col-md-6 p-1">
                    <a href="{{url('product-details')}}">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="{{url('img/collection/Banner-3.jpg')}}"
                                    class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-4">
                                <div>
                ...
                <div class="col-lg-3 col-md-6 p-1">
                    <a href="{{url('product-details')}}">
                        <div class="collection-banner p-right text-right">
                            <div class="img-part">
                                <img src="{{url('img/collection/Banner.jpg')}}" class="img-fluid blur-up lazyload bg-img">
                            </div>
                            <div class="contain-banner banner-4">
                                <div>
                                    <h4>save 30%</h4>
