 <!-- footer -->
    <footer class="footer-light">
        @include("website.layout.footer-newsletter")
        @include("website.layout.footer-link")
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="footer-end">
                            <p><i class="fa fa-copyright" aria-hidden="true"></i> 2021 E-Commerce</p>
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6 col-sm-12">
                        <div class="payment-card-bottom">
                            <ul>
                                <li>
                                    <a href="#"><img src="{{url('img/icon/visa.png')}}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{url('img/icon/mastercard.png')}}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{url('img/icon/paypal.png')}}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{url('img/icon/american-express.png')}}" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="{{url('img/icon/discover.png')}}" alt=""></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="buy_btn">
                    <a href="#"
                        target="_blank" class="btn btn-block purchase_btn"><i class="fa fa-shopping-cart"
                            aria-hidden="true"></i> purchase Mobile now!</a>
                    <a href="#"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{url('assets/images/icon/angular.png')}}"
                            alt="" class="img-fluid"> Android</a>
                    <a href="#"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{url('assets/images/icon/react.png')}}"
                            alt="" class="img-fluid"> Iphone</a>
                    <a href="#"
                        target="_blank" class="btn btn-block purchase_btn"><img src="{{url('assets/images/icon/shopify.png')}}"
                            alt="" class="img-fluid"> Headphone</a>
                </div>
            </div>
        </div>
    </div>
